...
#endif
{
    public partial class DataSync<T>
    {
        ...
        ReplicationDetails<T> CreateReplicationDetails()
        {
            ...
            var docAndrevisionComparer = new RevisionHashComparer();
            try
            {
                ...
                var deletedRevisions = documentsAfterSync
        ...
        public string PullFilter
        {
            ...
            set
            {
                _pullFilter = string.Format("pullreplication/{0}", value);
            }
        }
    ...
    internal class RevisionComparer : IEqualityComparer<Revision>
    {
        public bool Equals(Revision x, Revision y)
        {
            if (Object.ReferenceEquals(x, y)) return true;
            if (Object.ReferenceEquals(x, null) || Object.ReferenceEquals(y, null)) return false;
            return x.revid == y.revid;
        }
        public int GetHashCode(Revision obj)
        {
            if (Object.ReferenceEquals(obj, null)) return 0;
            return obj.revid.GetHashCode();
        }
    }

    internal class RevisionHashComparer : IEqualityComparer<Revision>
    {
        public bool Equals(Revision x, Revision y)
        {
            if (Object.ReferenceEquals(x, y)) return true;
            ...
            return x.docHash == y.docHash;
        }
        public int GetHashCode(Revision obj)
        {
            if (Object.ReferenceEquals(obj, null)) return 0;

            return obj.docHash.GetHashCode();
        }
    }
